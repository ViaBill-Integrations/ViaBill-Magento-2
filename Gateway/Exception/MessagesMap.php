...
class MessagesMap
{
    ...
    private function loadDefaultMessages()
    {
        $this->messages = [
            'capture' => [
                400 => __('Error when trying to capture the order - please contact Viabill for more information.'),
                403 => __('Capture is not longer possible for this transaction - please contact Viabill for more information.'), // @codingStandardsIgnoreLine
                409 => __('You are not allowed to make several capture attempts in a very short time - please try again in 15 minutes or contact Viabill for more info.'), // @codingStandardsIgnoreLine
                500 => __('Error when trying to capture the transaction - please try again in 15 minutes.')
            ],
            'refund' => [
                400 => __('Error when trying to refund the transaction - please contact Viabill for more information.'),
            ...
            'renew' => [
                400 => __('It\'s not possible to renew the order at the moment - please contact Viabill for more information.'), // @codingStandardsIgnoreLine
